...
import { X, Printer, Download, User, MapPin, Phone, Briefcase, Zap, Calendar, Wrench, Layers, CheckCircle2, History, ShieldCheck, Mail, FileText } from 'lucide-react';
...
const ComprehensiveDetailModal = ({ isOpen, onClose, data, type, onPrint, onSave, clientes }) => {
    ...
    // Helper to get client name if data is task
    const getClientInfo = () => {
                    ...
                    {isTask ? (
                        ...
                        <div className="space-y-6">
                            <div className="flex flex-col items-center py-4">
                                <div className="w-24 h-24 bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl border-2 border-orange-500/20 p-4 mb-4 transform -rotate-3 transition-transform hover:rotate-0">
                                ...
                                <div className="bg-white dark:bg-slate-900 p-5 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest italic leading-none text-left">Línea de Contacto</p>
                                            <p className="text-sm font-black text-slate-700 dark:text-slate-200 mt-1 font-mono">{data.telefono}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest italic leading-none text-left">Punto de Despliegue</p>
                                            <p className="text-xs font-black text-slate-700 dark:text-slate-200 mt-1 uppercase italic text-left">{data.direccion}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest italic leading-none text-left">Identificación Fiscal</p>
                                            <p className="text-xs font-black text-slate-700 dark:text-slate-200 mt-1 uppercase italic">{data.cedula || data.identificacion || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
